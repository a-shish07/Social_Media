...
function Header() {
  const [showAddPostForm, setShowAddPostForm] = useState(false); // State to toggle form visibility

  const handleToggleForm = () => {
    setShowAddPostForm((prevState) => !prevState); // Toggle the visibility of AddPostForm
  };
